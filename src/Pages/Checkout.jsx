  ...
  return (
    <div className="m-2">
      ...
      <div className="flex justify-center mt-2">
        <h1 className="text-3xl font-bold">Total:$ {state.total}</h1>
      </div>
      <div className="flex flex-col justify-center mt-4"> 
        <p className="font-bold m-2 text-xl">Proceed with payment?</p>
        <div className="flex flex-row">
            <button onClick={() => dispatch({type:"REMOVE_ALL"})} className="m-2 text-sm font-semibold bg-lightBlue text-white rounded p-2 hover:bg-lightBlue"><Link to="/purchase_complete">Complete Purchase</Link></button>
